 ...
 */
final class Version20210530142504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande RENAME INDEX fk_2694d7a5bcf5e72d TO IDX_2694D7A5BCF5E72D');
        $this->addSql('ALTER TABLE offre ADD users_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande RENAME INDEX idx_2694d7a5bcf5e72d TO FK_2694D7A5BCF5E72D');
